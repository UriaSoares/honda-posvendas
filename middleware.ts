...
const PUBLIC_PATHS  = ["/login", "/register", "/display", "/api/auth/login", "/api/auth/register", "/api/auth/logout", "/api/display", "/api/admin/promo", "/api/painel/", "/api/whatsapp/webhook"];
